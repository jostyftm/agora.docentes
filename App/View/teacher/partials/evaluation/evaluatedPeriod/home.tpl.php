                        ...
                        success: function (data) {
                        	...
                        	$('#item-posicion').find('th[data-estado="false"]').each(function (i, element) {
                        		...
                        		.done(function (datos) {
                        			...
                        			$(element).append('<span class="delete-pos" data-pos="'+pos+'" data-desemp="'+datos+'" data-grup="'+id_asignature+'" data-asign="'+id_group+'"> <i class="fa fa-trash" aria-hidden="true"></i></span>');
